...
var NativeReplSet = require('mongodb').ReplSetServers;
...
var ServerConnector = function(address, options) {
    this._native = _makeNativeServer(address, options);
};
...
var ReplicaSetConnector = function(addresses, options) {
    ...
    this._native = new NativeReplSet(nativeServers, options || {});
};
 ...
 * @returns {DB}
 */
ReplicaSetConnector.prototype.getDB = function(name, options) {  // TODO: superclass
    var result = new DB(this, name, options);
    sync(result._nativeDB, 'open', []);
    return(result);
};
...
if (typeof exports != "undefined") {
    ...
    exports.ReplicaSetConnector = ReplicaSetConnector;
}
